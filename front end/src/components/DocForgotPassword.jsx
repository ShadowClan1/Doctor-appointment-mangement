...
function DocForgotPassword() {
  ...
  const handleClick = async (e) => {
    localStorage.clear();
    await fetch(`http://localhost:5000/doc-forgot-password`, {
      method: "POST",
      headers: {
  ...
  return (
    <div className="h-screen">
      <div className="flex flex-col items-center h-3/4  justify-evenly  ">
        ...
        <button
          onClick={handleClick}
          className={`px-10 py-3 text-white hover:text-black rounded-full   bg-blue-500 hover:bg-blue-400 `}
        >
